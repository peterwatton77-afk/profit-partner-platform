...
const plans = [
  {
    ...
    features: [
      { text: "Beginner guides", ok: true }, { text: "Limited OddsMatcher", ok: true },
      { text: "Basic calculator", ok: true }, { text: "Full tools access", ok: false },
    ],
    highlighted: false,
  },
  {
    name: "Premium", price: "£24.99", period: "/month",
    features: [
      { text: "All tools unlimited", ok: true }, { text: "Daily reload offers", ok: true },
      { text: "Profit Tracker", ok: true }, { text: "Priority support", ok: true },
    ],
    highlighted: true,
  },
];
...
const OutplayedLanding = () => {
  return (
    <BrandProvider defaultBrand="outplayed">
      <div className="min-h-screen bg-background">
        {/* Navbar */}
        <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8 h-16">
            <span className="font-display text-xl font-bold tracking-tight text-gradient">Outplayed</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <Button size="sm" className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold">Start Free</Button>
            </div>
          </div>
        </nav>
        ...
        <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,hsl(245_58%_63%/0.08),transparent_50%)]" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
            <div className="text-center max-w-4xl mx-auto">
              <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                ...
                <Zap size={14} /> Smart Betting. Real Profit.
              </motion.span>
              <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
                className="font-display text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight leading-[1.1] mb-6">
                Turn Sports Knowledge Into{" "}<span className="text-gradient">Profit</span>
              </motion.h1>
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
                className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
                Outplayed gives you powerful tools and daily offers to extract guaranteed profit from bookmaker promotions. Join the smartest community in sports betting.
              </motion.p>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
                ...
                <div className="glass-card p-6 text-center"><AnimatedCounter target={32000} suffix="+" /><p className="text-sm text-muted-foreground mt-1">Active Members</p></div>
                <div className="glass-card p-6 text-center"><AnimatedCounter target={1200} prefix="£" suffix="+" /><p className="text-sm text-muted-foreground mt-1">Avg. Monthly Profit</p></div>
                <div className="glass-card p-6 text-center"><AnimatedCounter target={18} suffix="M+" /><p className="text-sm text-muted-foreground mt-1">Total Profit Made (£)</p></div>
              </motion.div>
        ...
        <section id="op-pricing" className="section-padding relative">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,hsl(245_58%_63%/0.04),transparent_50%)]" />
        ...
        <footer className="border-t border-border bg-card/50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <span className="font-display text-xl font-bold text-gradient">Outplayed</span>
              <p className="text-xs text-muted-foreground">© {new Date().getFullYear()} Outplayed. 18+ only. Please gamble responsibly.</p>
            </div>
          </div>
        </footer>
      </div>
